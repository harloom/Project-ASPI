      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo">Peserta</a>
          </div>
            ...
            <div class="col-lg-12 col-md-12">
              <div class="card">
                <div class="card-header card-header-warning">
                  ...
                  <p class="card-category">Peserta <?=date("d-m-Y")?></p>
                </div>
                <div class="card-body table-responsive">
                  <table class="table table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><?=$i?></td>
                        <td><img src="<?="upload/" . $dt["url_imageKTP"]?>" width="50"/></td>
                        <td><?=$dt["nama_depan"] . " " . $dt["nama_belakang"]?></td>
                        <td><?=$dt["no_handphone"]?></td>
                        <td>
                        <a href="detail.php?detail=<?= $dt["id_peserta"];?>">  
      ...
      <footer class="footer">
        <div class="container-fluid">
          ...
          <div class="copyright float-right">
            ...
            <a href="" target="_blank">Harloom </a> for a better web.
          </div>
        </div>
      </footer>
    </div>
